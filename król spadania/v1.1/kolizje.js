...
function SprawdzStroneKolizji(IdKolizji)
{
    ...
    if(PozycjaGracza[0]+(Graczwidth/2)<=OdlegloscLewej && PozycjaGracza[1]-(Graczheight/2)>=OdlegloscDolnej ||
     PozycjaGracza[0]+(Graczwidth/2)<=OdlegloscLewej && PozycjaGracza[1]+(Graczheight/2)<=OdlegloscGory ||
      PozycjaGracza[0]-(Graczwidth/2)>=OdlegloscPrawej && PozycjaGracza[1]-(Graczheight/2)>=OdlegloscDolnej ||
       PozycjaGracza[0]-(Graczwidth/2)>=OdlegloscPrawej && PozycjaGracza[1]+(Graczheight/2)<=OdlegloscGory)
    {
    ...
    if(PozycjaGracza[0]+(Graczwidth/2)>OdlegloscLewej && PozycjaGracza[0]-(Graczwidth/2)<OdlegloscPrawej && ListaAktualnychObiektowDoKolizji[IdKolizji][3])
    {
    ...
    if(PozycjaGracza[1]+(Graczheight/2)>OdlegloscGory && PozycjaGracza[1]-(Graczheight/2)<OdlegloscDolnej && ListaAktualnychObiektowDoKolizji[IdKolizji][4])
    {
...
function Kolizje()
{
    for(i=0;i<mapa[AktualnaMapa].length;i++)
    {
        ...
        if(SprawdzKolizjeX(PozycjaX,Graczwidth,i,0))
        {

            if(PozycjaX+Graczwidth >= mapa[AktualnaMapa][i][1] && ListaAktualnychObiektowDoKolizji[i][2]=="nalewo")
            {
                PozycjaX = mapa[AktualnaMapa][i][1]-Graczwidth-3;
            ...
            if(SprawdzKolizjeY(PozycjaY,Graczheight,i,0))
            {
                ...
                if(PozycjaY+Graczheight >= mapa[AktualnaMapa][i][2] && ListaAktualnychObiektowDoKolizji[i][2]=="nad")
                {
                    Spada=false;
                    PozycjaY = mapa[AktualnaMapa][i][2]-Graczheight;
                    grawitacja=0;
